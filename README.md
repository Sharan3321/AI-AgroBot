...
*Main chatbot interface with AI-powered responses*
...
**Note**: Add your actual screenshots to the `screenshots/` folder with the names: `landing.png`, `register.png`, `login.png`, `chat.png`, `profile.png`, `admin.png`
